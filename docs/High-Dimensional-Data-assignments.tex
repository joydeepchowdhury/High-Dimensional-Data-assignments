...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lambda\_min\_lasso }\OtherTok{=}\NormalTok{ cv\_fit\_lasso}\SpecialCharTok{$}\NormalTok{lambda.min}
\FunctionTok{writeLines}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{\textquotesingle{}Cross{-}validated lambda for lasso:\textquotesingle{}}\NormalTok{,}
\NormalTok{                 lambda\_min\_lasso))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{lambda\_min\_ridge }\OtherTok{=}\NormalTok{ cv\_fit\_ridge}\SpecialCharTok{$}\NormalTok{lambda.min}
\FunctionTok{writeLines}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{\textquotesingle{}Cross{-}validated lambda for ridge:\textquotesingle{}}\NormalTok{,}
\NormalTok{                 lambda\_min\_ridge))}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Accessing the lambda value corresponding to the minimum}
\CommentTok{\# cross{-}validated error}
\NormalTok{lambda\_min\_elnet }\OtherTok{=}\NormalTok{ cv\_fit\_elnet}\SpecialCharTok{$}\NormalTok{lambda.min}
\FunctionTok{writeLines}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{\textquotesingle{}Cross{-}validated lambda for elastic net:\textquotesingle{}}\NormalTok{,}
\NormalTok{                 lambda\_min\_elnet))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{lambda\_min\_group }\OtherTok{=}\NormalTok{ cv\_fit\_group}\SpecialCharTok{$}\NormalTok{lambda.min}
\FunctionTok{writeLines}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{\textquotesingle{}Cross{-}validated lambda for group lasso:\textquotesingle{}}\NormalTok{,}
\NormalTok{                 lambda\_min\_group))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{lambda\_min\_fused }\OtherTok{=}\NormalTok{ cv\_fit\_fused}\SpecialCharTok{$}\NormalTok{lambda.min}
\FunctionTok{writeLines}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{\textquotesingle{}Cross{-}validated lambda for fused lasso:\textquotesingle{}}\NormalTok{,}
\NormalTok{                 lambda\_min\_fused))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Loading the data from the package \textquotesingle{}multtest\textquotesingle{}}
\FunctionTok{data}\NormalTok{(}\StringTok{\textquotesingle{}golub\textquotesingle{}}\NormalTok{, }\AttributeTok{package =} \StringTok{\textquotesingle{}multtest\textquotesingle{}}\NormalTok{)}

\CommentTok{\# Storing the data corresponding to ALL cases in the}
\CommentTok{\# variable golub\_ALL}
\NormalTok{golub\_ALL }\OtherTok{=}\NormalTok{ golub[,}\DecValTok{1}\SpecialCharTok{:}\DecValTok{27}\NormalTok{]}

\CommentTok{\# Storing the data corresponding to AML cases in the}
\CommentTok{\# variable golub\_AML}
\NormalTok{golub\_AML }\OtherTok{=}\NormalTok{ golub[,}\DecValTok{28}\SpecialCharTok{:}\DecValTok{38}\NormalTok{]}

\CommentTok{\# m is the number of tests, which is equal to the}
\CommentTok{\# number of genes}
\NormalTok{m }\OtherTok{=} \FunctionTok{nrow}\NormalTok{(golub)}

\CommentTok{\# Computing the p{-}values using a two{-}sample t test}
\NormalTok{p }\OtherTok{=} \FunctionTok{c}\NormalTok{()}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\NormalTok{m)}
\NormalTok{  p[i] }\OtherTok{=} \FunctionTok{t.test}\NormalTok{(golub\_ALL[i,], golub\_AML[i,],}
                \AttributeTok{alternative =} \StringTok{\textquotesingle{}two.sided\textquotesingle{}}\NormalTok{)}\SpecialCharTok{$}\NormalTok{p.value}
